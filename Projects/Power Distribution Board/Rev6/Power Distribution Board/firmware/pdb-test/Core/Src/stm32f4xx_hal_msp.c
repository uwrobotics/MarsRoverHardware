...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, ADC_INPUT_5V_2_Pin|ADC_INPUT_5V_1_Pin|LOAD_VBAT_BUCK_Pin);

    HAL_GPIO_DeInit(VBAT_ADC_INPUT_GPIO_Port, VBAT_ADC_INPUT_Pin);

    HAL_GPIO_DeInit(GPIOB, ADC_17V_INPUT_Pin|LOAD_17V_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA4     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(ADC_INPUT_5V_1_GPIO_Port, ADC_INPUT_5V_1_Pin);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE END CAN1_MspDeInit 0 */
    ...
    PA12     ------> CAN1_TX
    */
    HAL_GPIO_DeInit(GPIOA, CAN_RX_A_Pin|CAN_TX_A_Pin);
  ...
  /* USER CODE END CAN2_MspDeInit 0 */
    ...
    PB13     ------> CAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, CAN_RX_B_Pin|CAN_TX_B_Pin);
