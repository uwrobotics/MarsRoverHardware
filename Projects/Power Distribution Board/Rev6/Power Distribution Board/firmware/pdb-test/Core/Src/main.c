...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  /*port all adc using dma circular/
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : PA1 ADC_INPUT_5V_1_Pin LOAD_ODRIVE_3_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_1|ADC_INPUT_5V_1_Pin|LOAD_ODRIVE_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
